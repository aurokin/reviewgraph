...
- Linear description was previously tightened to remove marker-plan and second-POST contradictions. Completion still requires refreshing the issue description checkboxes, adding evidence, and moving the issue to `Done`.
