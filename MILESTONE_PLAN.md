...
- Real writer adapter supports only finalized top-level issue comments and handles ambiguous accepted-write timeouts through writer-local marker recovery before any retry.
