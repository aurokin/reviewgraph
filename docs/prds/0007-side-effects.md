...
- The real writer may perform marker rescans only as writer-local recovery after an ambiguous accepted-write POST result; normal pre-write marker reconciliation remains finalization-owned.
